...
A **Agência de viagens** é uma Landing Page moderna e responsiva desenvolvida com foco em **SEO (Search Engine Optimization)** e boas práticas de Front-end. O projeto simula a página de uma agência de viagens, apresentando lugares, pacotes e novidades.
...
```bash
EXPOMOTO/
├── styles.css          # Arquivo com os códigos css
├── img                 # Imagens
